...
/**
  ...
  */
trait BlogJsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  implicit val postMetadataFormat = jsonFormat5(PostMetadata)
  ...
  implicit val author= jsonFormat2(Author)
}
